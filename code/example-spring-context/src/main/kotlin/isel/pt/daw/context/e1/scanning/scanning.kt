package isel.pt.daw.context.e1.scanning
...
fun main() {
    ...
    context.scan("isel.pt.daw.context.e1.scanning")
     ...
     * - Instead, the `isel.pt.daw.context.e1.scanning` package is scanned for classes that have the `@Component` annotation.
